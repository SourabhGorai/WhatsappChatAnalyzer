...
def create_wordcloud(selected_user, df):
    ...
    f = open('D:/01Old/Python/Projects/Whatsapp Chat Anylisis/whatsapp_Chat_analyzer/stop_hinglish.txt','r')
    stop_words = f.read()
...
def emoji_helper(selected_user, df):
    ...
    emojis = []
    for message in df['message']:
        emojis.extend([c for c in message if c in emoji.EMOJI_DATA])  # Use emoji.EMOJI_DATA for checking valid emojis
